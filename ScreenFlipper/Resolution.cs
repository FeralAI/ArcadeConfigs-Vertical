...
{
    static public string ChangeResolution(int quarterTurns)
    {
        ...
        if (0 != NativeMethods.EnumDisplaySettings(null, NativeMethods.ENUM_CURRENT_SETTINGS, ref dm))
        {
            ...
            dm.dmPelsWidth = temp;
            dm.dmDisplayOrientation = (dm.dmDisplayOrientation + quarterTurns) % 4;
        ...
        else return "Failed To Change The Resolution.";
    }
